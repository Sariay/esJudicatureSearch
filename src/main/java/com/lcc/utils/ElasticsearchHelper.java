...
public class ElasticsearchHelper {
     ...
     * @Description 将Mysql中的数据导入elasticsearch, 并为所有数据创建索引(1-创建索引; 2-设置mapping; 3-查询Mysql并将数据写入elasticsearch索引池)
     * @Param []
     * @Return void
     **/
    public static void daoMysqlToElasticsearch() {
        final String currentIndexName = ElasticsearchConfig.INDEX_NAME.getValue();
        ...
        dataDao.getDataFromMysql(indexTemplate);
    }
}